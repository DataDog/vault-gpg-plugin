...
This endpoint creates, under a given master key, a new GPG subkey with the specified key type, capabilities, as well as size, and returns the GPG Key ID of this new subkey.
...
This endpoint returns information, such as the key type, capabilities, and size, about a given subkey associated with a given master key.
